version 1 contains the full calculator for all four forces including the high energy environment simulation.
version 2 expands how much data is gathered in each step before plotting and does not contain the fundamental forces calculator
...
** all other modules used are included with Python3 except for matplotlib which is utilized for the plot graphs. to install simply pip install matplotlib.
